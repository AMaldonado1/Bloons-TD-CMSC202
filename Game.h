...
const int DAMAGE_BOOM = 1; // Starting damage for boomerang monkey
const int DAMAGE_BOMB = 1; // Starting damage for bomb monkey

// Constants related to the special bloons
const int ZEBRA_HEALTH = 1;   // Health of the zebra bloon
const int LEAD_HEALTH = 1;    // Health of the lead bloon
const int SPLIT_HEALTH = 10;  // Health of the split bloon
const int ZEBRA_DAMAGE = 21;  // Starting damage for the zebra bloon
const int LEAD_DAMAGE = 11;   // Starting damage for the lead bloon
const string ZEBRA = "zebra"; // Name of the zebra bloon
const string LEAD = "lead";   // Name of the lead bloon
